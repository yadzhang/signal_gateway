...
CVarChar32 CMsgMapHelper::generateRtcSessionID(CVarChar64 callIDNumber, CVarChar32 tag){
	return tag;
}

CVarChar64 CMsgMapHelper::generateSipCallIDNumber(CVarChar32 sessionID){
...
CVarChar32 CMsgMapHelper::generateSipTag(CVarChar32 sessionID){
	return sessionID;
}
...
void CMsgMapHelper::storeSipCallID(CVarChar32 sessionID, CVarChar64 callIDNumber){	
	pthread_mutex_lock(&mutex);
...
CVarChar64 CMsgMapHelper::getSipCallID(CVarChar32 sessionID){
	pthread_mutex_lock(&mutex);
	string strSessionID(sessionID.c_str());
	CVarChar64 callIdNumber;
...
void CMsgMapHelper::clearRtcToSipMap(CVarChar64 callIDNumber){
	pthread_mutex_lock(&mutex);
