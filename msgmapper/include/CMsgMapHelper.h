...
class CMsgMapHelper{
public :
	static CVarChar32 generateRtcSessionID(CVarChar64 callIDNumber, CVarChar32 tag);
	static CVarChar64 generateSipCallIDNumber(CVarChar32 sessionID);
	static CVarChar32 generateSipTag(CVarChar32 sessionID);

//	static CVarChar32 getRtcSessionID(CVarChar64 callIDNumber, CVarChar32 tag);


	static CVarChar32 getSipTag(CVarChar32 sessionID);
//	static CVarChar64 getSipCallIDNumber(CVarChar32 sessionID);

	static CVarChar64 getSipCallID(CVarChar32 sessionID);
	
	static void storeSipCallID(CVarChar32 sessionID, CVarChar64 callIDNumber);
//	static void storeRtcToSipMap(CVarChar32 sessionID, CVarChar64 callIDNumber, CVarChar32 tag);
	static void clearRtcToSipMap(CVarChar64 callIDNumber);
private:
