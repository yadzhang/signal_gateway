...
clean: clean.rtc_psa clean.rtc_msgdef clean.rtc_db clean.dispatcher clean.deploy \
...
$(D_SRC_PSASIP)/sipenv.o $(D_SRC_PSASIP)/timerpoll.o $(D_SRC_PSASIP)/CSipUserManager.o
...
sip_call_module: $(OBJS_SIP_CALL)
	$(CXX) -shared -fPIC -o $(OUTPUT_DIR)/sip_call_module.so $(OBJS_SIP_CALL) -L$(DEPLOY_DIR) -lmsgmapper $(LIBS) -lsipmsgdef 
